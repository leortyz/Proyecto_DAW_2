        ...
        <section class="col-md-12 col-sm-12">
          <article class="col-md-12 col-sm-12">
            ...
            <div class="col-md-6 col-sm-6">
              <h2 class="col-md-12 col-sm-12 caja_integrantes">INTEGRANTES:</h2>
              <ul class="col-md-12 col-sm-12 lista_integrantes">
                <li class="integrantes texto">EMILIO MORAN PILLIGUA</li>
                <li class="integrantes texto">LUIS TORO YEROVI</li>
              </ul>
            </div>
            <div class="col-md-3 col-sm-3">
