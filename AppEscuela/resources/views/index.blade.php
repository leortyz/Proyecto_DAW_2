...
<html lang="es">
  ...
  <body>
        ...
        <section class="col-md-12 col-sm-12">
          <div class="row">
            <div class="col-md-8 col-sm-8">
              <figure class="col-md-12 col-sm-12">
                <img class="col-md-12 col-sm-12 img-fluid" src="../static/img/portada.JPG" alt="">        
              </figure>
              <!--<a class="col-md-12 col-sm-12 portada" href="https://placeholder.com"><img class="col-12 col-sm-12" src="https://via.placeholder.com/520x230" alt="imagen escuela"></a>-->          
            </div>
            <div class="col-md-4 col">
              <article class="col-md-12 col-sm-12">
                <h2 class="col-md-12 col-sm-12 caja_noticia texto">NOTICIAS</h2>
                <h3 class="col-md-12 col-sm-12" id="titulo_noticia"></h3>
                <p class="col-md-12 col-sm-12 texto" id="descripcion_noticia"></p>
                <div class="col-md_12 col-sm-12 div_arrow">
                   <button id="id_cambiar" class="btn btn-primary btn-change">&#8250;</button>
                </div>
              </article>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <article class="col-md-12 col-sm-12">
                <h2 class="col-md-12 col-sm-12 caja_mapa">¿DONDE UBICARNOS?</h2>              
                <div class="col-md-12 col-sm-12 div_map" id="googleMap"></div>
              </article>    
            </div>
          </div>
        </section>  
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB82ZlwAmhclE5UT8a5ULc-wZhC9QKOT8Q&callback=myMap"></script>
